...
face_exp_model = model_from_json(open("D:\\Udemy courses\\Computer vision for face detection\\dataset\\facial_expression_model_structure.json","r",encoding="utf-8").read())
face_exp_model.load_weights('D:\\Udemy courses\\Computer vision for face detection\\dataset\\facial_expression_model_weights.h5')
