...
face_detection_classifier = cv2.dnn.readNetFromCaffe('D:\\Udemy courses\\Computer vision for face detection\\models\\deploy.prototxt.txt','D:\\Udemy courses\\Computer vision for face detection\\models\\res10_300x300_ssd_iter_140000.caffemodel')
